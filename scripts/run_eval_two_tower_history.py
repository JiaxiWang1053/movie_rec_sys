...
from src.training.train_two_tower_history import train_two_tower_history
...
def main():
    ...
    # ===== 加载权重 =====
    model.load_state_dict(torch.load("checkpoints/two_tower_history.pth"))
