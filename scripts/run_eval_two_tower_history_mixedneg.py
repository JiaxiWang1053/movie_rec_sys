...
def main():
    ...
    # 2. 加载 mixed negative 版本权重
    model.load_state_dict(
        torch.load("checkpoints/two_tower_history_mixedneg.pth", map_location=device)
    )
    print("模型加载完成：two_tower_history_mixedneg.pth")
    ...
    print("\n双塔 + History + Mixed Negative 召回结果：")
