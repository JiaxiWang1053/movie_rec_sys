...
from src.training.train_deepfm_ranker import train_deepfm_ranker
...
def main():
    ...
    train_deepfm_ranker(
        ...
        num_epochs=5,
        device=device,
        save_path="checkpoints/deepfm_ranker.pth"
    )
    ...
    # ===== 3. 加载最佳模型与标准化参数 =====
    ckpt = torch.load("checkpoints/deepfm_ranker.pth", map_location=device)
