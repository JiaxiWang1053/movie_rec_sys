...
from src.models.two_tower_history_mlp import (
    TwoTowerHistoryMLPRetrievalModel,
    bpr_loss
)
from src.data.load_movielens import load_ml_1m


def train_two_tower_history_mlp_mixedneg(
    data_path: str,
    ...
    random_seed: int = 42,
    device: str = "cuda",
    save_path: str = "checkpoints/two_tower_history_mlp_mixedneg.pth"
):
    """
    训练最终版本：
